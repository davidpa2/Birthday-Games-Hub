        ...
        <div ref={myRef} style={{ width: '100vw', height: '100vh', position: 'absolute', top: '0', left: '0' }}>
            {<div style={{
                ...
                <div className="w-96 p-6 border-3 rounded-xl shadow-xs bg-gray-800/25">
                    <svg className="w-7 h-7 mb-3 flex-row left-1/2 right-1/2 mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
