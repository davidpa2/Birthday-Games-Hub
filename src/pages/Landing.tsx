    ...
    return (
        <div ref={myRef} style={{ width: '100vw', height: '100vh', position: 'absolute', top: '0', left: '0' }}>
            {<div style={{
                ...
                <div className="w-98 p-6 border-3 rounded-xl shadow-xs bg-gray-800/25">
                    ...
                    <Link to={"/games"} className="inline-flex font-medium items-center text-fg-brand hover:underline">
                        ¡A jugar!
