...
const Games = (props: Props) => {
  return (
    <div className="w-96 h-56 border-3 rounded-xl shadow-xs bg-gray-800/25" style={{backgroundImage: "url(" + "src/assets/36.png" + ")", backgroundPosition: 'center', backgroundSize: '100%'}}>
